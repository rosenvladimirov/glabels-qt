...
panel. Or click on **Print** in the sidebar. Once print options have been
selected, click **Print** to print the labels or cards.  You see a print
preview at the right side of the window.
...
clear labels that will be viewed from the reverse side (for example, in a car
window).
